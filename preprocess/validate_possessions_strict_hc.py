            ...
            for poss in game_possessions:
                ...
                if half_court:
                    ...
                    if half_court and (first_time_hc - poss.end_event.ev_game_clock).total_seconds() < min_hc_secs:
                        ...
                        half_court = False
                    if half_court:
                        all_moments_count = poss_moments.count()
                        if all_moments_count < 25 * ( - 1) or hc_moments_count > 25 * examine_hc_secs + 5:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-beg_end_buffer', '-B', type=float)
    args = parser.parse_args()

    validate_possessions(args.min_hc_secs, args.examine_hc_secs, args.beg_end_buffer)
